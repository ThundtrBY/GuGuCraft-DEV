...
StartupEvents.registry('item', e =>{
  ...
  e.create('incomplete_engineering_processor').displayName('工程电路板(半成品)')
  e.create('incomplete_calculation_processor').displayName('运算电路板(半成品)')
  e.create('incomplete_logic_processor').displayName('逻辑电路板(半成品)')
})

...
StartupEvents.registry('item', e =>{
  ...
  e.create('zero').displayName("0")
  e.create('one').displayName("1")
  e.create('two').displayName("2")
  e.create('three').displayName("3")
  e.create('four').displayName("4")
  e.create('five').displayName("5")
  e.create('six').displayName("6")
  e.create('seven').displayName("7")
  e.create('eight').displayName("8")
  e.create('nine').displayName("9")
